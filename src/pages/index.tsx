...
const IndexPage: React.FC<IndexPageProps> = () => (
  <>
    ...
    <div className="w-full bg-center bg-cover bg-[url('/helldivers-malevelon-creek-banner.png')]">
        ...
        <div className="text-center">
          <div className="container px-4 mx-auto">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="mt-8 mb-6 text-4xl lg:text-5xl font-bold text-gray-100">
                Malevelon Creek has been Liberated!
              </h2>
              <p className="max-w-3xl mx-auto mb-10 text-lg text-gray-300">
                Celebrate with new Malevelon Creek Memorial Merch.
              </p>
              <Link href="/soft-goods">
