...
const IndexPage: React.FC<IndexPageProps> = () => (
  <>
    ...
    {/* <div className="w-full bg-center bg-cover bg-[url('/helldivers-banner.png')]"> */}
        ...
        <div className="text-center">
          <div className="container px-4 mx-auto">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="mt-8 mb-6 text-4xl lg:text-5xl font-bold text-gray-100">
                Safeguard the Herd. Protect the Tribe.
              </h2>
              <p className="max-w-3xl mx-auto mb-10 text-lg text-gray-300">
                For now, we&apos;re taking a break. Site will allow checkout again soon! Thanks!
              </p>
              <Link href="/soft-goods">
